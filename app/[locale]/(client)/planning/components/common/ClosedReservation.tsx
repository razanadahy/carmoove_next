...
const ClosedReservation = ({ reservations, freeFloating, allDrivers, loading, currentUser, vehicles }:
                           { reservations: IReservation[], freeFloating?: boolean,  allDrivers: IDriver[], loading: boolean, currentUser: IUserCS,  vehicles?: IVehicle[] }) => {
    ...
    return (
        <>
            {loading ? <Loading msg={"chargment des chauffeurs"}/> : <>
                <div className="reservation-main-box mb-5 pb-4">
                    {
                        paginated.length > 0 ?
                            ...
                            :
                            <span className="no-reservation-content">
